This is a small library intended to help with data cleaning. It differs from (d)plyr and tidyr in that it's not so much for reshaping data as it is for forcing the data to assume a measure of sanity. 
